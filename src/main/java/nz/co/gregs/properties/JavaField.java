...
import nz.co.gregs.properties.exceptions.FailedToSetPropertyValueOnRowDefinition;
...
public class JavaField implements JavaProperty {
	...
	public Object get(Object target) {
		try {
			...
			throw new PropertyException("Java security error reading field " + qualifiedName() + ": " + e.getLocalizedMessage(), e);
		}
	}
	...
	public void set(Object target, Object value) {
		try {
			...
			// caused by a Java security manager or an attempt to access a non-visible field
			// without first making it visible
			throw new PropertyException("Java security error writing field " + qualifiedName() + ": " + e.getLocalizedMessage(), e);
		}
	}
